...
classdef DefocusMovies < manookinlab.protocols.ManookinLabStageProtocol
    ...
    methods
        ...
        function prepareRun(obj)
            ...
            for i = 1:length(ls_movies)
                if sum(strfind(ls_movies(i).name,'.mp4')) > 0
                    obj.moviePaths{i,1} = ls_movies(i).name;
                end
            end
            ...
            if obj.randomize
                ...
                seq = (1:size(obj.moviePaths,1));
                for ii = 1 : num_reps
                    seq = randperm(size(obj.moviePaths,1));
