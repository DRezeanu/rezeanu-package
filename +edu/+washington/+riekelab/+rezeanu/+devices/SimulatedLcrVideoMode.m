classdef SimulatedLcrVideoMode < symphonyui.core.Device
    ...
    methods
        function obj = SimulatedLcrVideoMode(varargin)
            ip = inputParser();
            ...
            cobj = Symphony.Core.UnitConvertingExternalDevice(['SimulatedLcrVideo Stage@' ip.Results.host], 'Unspecified', Symphony.Core.Measurement(0, symphonyui.core.Measurement.UNITLESS));
